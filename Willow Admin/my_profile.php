                        ...
                        <div class="white_card_header">
                           <div class="box_header m-0">
                              <div class="main-title">
                                 <h1 class="m-0" style="font-size:3em;">My Profile</h1>
                              </div>
                           </div>
                        </div>
                        <div class="white_card_body">
                           <div class="card-body">
                              <img src="assets/img/me (1).png" width="400" height="400"> <br><br>
                                <h1> Pragya Maharjan </h1>
                                <p style="font-size:18px; "> Founder of Willow Closet</p>
                                <p style="font-size:18px; "> St. Xavier's College</p>
                           </div>
                        </div>
                     </div>
                  </div>
